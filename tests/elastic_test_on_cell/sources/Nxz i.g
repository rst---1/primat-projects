...
plot \
 "mata-quadrate i 10.gpd" using ($1/16384):($4) w l ti "{/Monospace=20 3 квадрат}" lt 1 lw WEIGHT,\
 "mata-shell i 10.gpd" using ($1/16384):($4) w l ti "{/Monospace=20 4 трубка}" lt 2 lw WEIGHT,\
 "mata-cross i 10.gpd" using ($1/16384):($4) w l ti "{/Monospace=20 5 крестовина}" lt 3 lw WEIGHT, \
 "mata-circ i 10.gpd" using ($1/16384):($4) w l ti "{/Monospace=20 6 круг}" lt 4 lw WEIGHT
