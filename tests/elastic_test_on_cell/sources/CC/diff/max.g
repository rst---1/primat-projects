...
set output "max_main_stress_1.png"
...
set ylabel "{/Symbol s_1^{/Nosymbol max}}" font "Serif, 30"# offset 2


plot \
 "min-max" using ($1*$1*3.14159265359):($2) w l ls 1 ti "" #"{/Serif=15 квадрат}"
