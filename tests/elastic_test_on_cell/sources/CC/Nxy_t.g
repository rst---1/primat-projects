...
set output "Nxy_t.png"
set multiplot
set origin 0.01,0.01
set size 0.99, 0.99
set xrange [ 0 : 7 ]
set yrange [ 0.17 : 0.23 ]
set xtics 0, 1, 7
...
plot \
 "mata-circ-0.gpd"  using ($15):($3) w lp ls 1 ti "{/Serif=15 0.0 }", \
 "mata-circ-24.gpd"  using ($15):($3) w lp ls 2 ti "{/Serif=15 0.024 }", \
 "mata-circ-97.gpd"  using ($15):($3) w lp ls 3 ti "{/Serif=15 0.097 }", \
 "mata-circ-152.gpd"  using ($15):($3) w lp ls 4 ti "{/Serif=15 0.152 }", \
 "mata-circ-219.gpd"  using ($15):($3) w lp ls 5 ti "{/Serif=15 0.219 }", \
 "mata-circ-299.gpd" using ($15):($3) w lp ls 6 ti "{/Serif=15 0.299 }", \
 "mata-circ-390.gpd" using ($15):($3) w lp ls 7 ti "{/Serif=15 0.390 }", \
 "mata-circ-494.gpd" using ($15):($3) w lp ls 8 ti "{/Serif=15 0.494 }", \
 "mata-circ-610.gpd" using ($15):($3) w lp ls 9 ti "{/Serif=15 0.610 }", \
 "mata-circ-738.gpd" using ($15):($3) w lp ls 10 ti "{/Serif=15 0.738 }"#, \
