...
plot \
 "../concrete/mata-quadrate.gpd" using ($1/16384):($8) w l ls 1 ti "{/Arial=25 1}",\
 "../concrete/mata-shell.gpd" using ($1/16384):($8) w l ls 2 ti "{/Arial=25 2}",\
 "../concrete/mata-cross.gpd" using ($1/16384):($8) w l ls 3 ti "{/Arial=25 3}", \
 "../concrete/mata-circ.gpd" using ($1/16384):($8) w lp ls 4 ti "{/Arial=25 4}"
