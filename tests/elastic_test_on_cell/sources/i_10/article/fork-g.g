...
plot \
 ...
 "../concrete/mata-quadrate.gpd" using ($1/16384):($13) w l ls 2 ti "{/Arial=25 2}", \
 "../concrete/mata-quadrate.gpd" using ($1/16384):($14) w l ls 3 ti "{/Arial=25 3}"#, \
 #"../concrete/mata-quadrate.gpd" using ($1/16384):(abs($13+$14)/2.0) w l ls 4 ti "{/Arial=25 4}"
