...
plot \
 "../concrete/mata-quadrate.gpd" using ($1/16384):($2/DEVIDER) w l ls 1 ti "{/Arial=25  1}", \
 "../concrete/mata-shell.gpd"    using ($1/16384):($2/DEVIDER) w l ls 2 ti "{/Arial=25  2}", \
 "../concrete/mata-cross.gpd"    using ($1/16384):($2/DEVIDER) w l ls 3 ti "{/Arial=25  3}", \
 "../concrete/mata-circ.gpd"     using ($1/16384):($2/DEVIDER) w lp ls 4 ti "{/Arial=25  4}", \
 "../concrete/mata-quadrate.gpd" using ($1/16384):(mean(1,16384-$1)/DEVIDER) w lp ls 5 ti "{/Arial=25  5}" , \
 "../concrete/mata-quadrate.gpd" using ($1/16384):(serial(16384-$1)/DEVIDER) w lp ls 6 ti "{/Arial=25  6}"#, \
