...
plot \
 "../concrete/mata-quadrate.gpd" using ($1/16384):($12) w lp ls 4 ti "{/Arial=25 1}",\
 ...
 "../concrete/mata-circ.gpd" using ($1/16384):($12) w l ls 1 ti "{/Arial=25 4}"
...
#set titl "Относительное отклонение от среднего \n ({/Symbol=10 l_s} - {{/Symbol=20 l}_с}) / {{/Symbol=20 l}_с} " font "Monospace, 20"
set origin 0.1,0.45
set size 0.5, 0.5
set noxlabel 
set noylabel
...
set key spacing 3.2
set grid x y
plot "../concrete/comp_c.gpd" using ($1):(($3-$2)/$2) w l ls 1 ti "",\
