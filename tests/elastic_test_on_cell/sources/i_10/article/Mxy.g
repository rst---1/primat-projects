...
plot \
 ...
 "../concrete/mata-shell.gpd" using ($1/16384):($11) w l ls 2 ti "{/Arial=25 2}",\
 "../concrete/mata-cross.gpd" using ($1/16384):($11) w l ls 3 ti "{/Arial=25 3}", \
 "../concrete/mata-circ.gpd" using ($1/16384):($11) w lp ls 4 ti "{/Arial=25 4}"
