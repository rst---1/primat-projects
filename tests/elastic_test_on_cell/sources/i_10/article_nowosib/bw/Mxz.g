...
plot \
 dir."mata-quadrate.gpd" using ($1/16384):($12) w lp ls 1 ti "{/Serif=20 квадрат}",\
 dir."mata-shell.gpd" using ($1/16384):($12) w lp ls 2 ti "{/Serif=20 трубка}",\
 dir."mata-cross.gpd" using ($1/16384):($12) w lp ls 3 ti "{/Serif=20 крестовина}", \
 dir."mata-circ.gpd" using ($1/16384):($12) w lp ls 4 ti "{/Serif=20 круг}", \
 "ch_fork.gpd" using ($1/16384):($12) w lp ls 5 ti "{/Serif=20 нижня оценка}" , \
 "ch_fork.gpd" using ($1/16384):($24) w lp ls 6 ti "{/Serif=20 верхняя оценка}", \
 "ch.gpd" using ($1/16384):($12) w lp ls 7 ti "{/Serif=20 формула Хашина-Хилла}"
...
#set grid x y
#plot \
# "../comparison_q_ch.gpd" u ($1):($12) w lp ls 1 ti "" , \
# "../comparison_s_ch.gpd" u ($1):($12) w lp ls 2 ti "" , \
# "../comparison_cr_ch.gpd" u ($1):($12) w lp ls 3 ti "" , \
# "../comparison_ci_ch.gpd" u ($1):($12) w lp ls 4 ti ""# , \
