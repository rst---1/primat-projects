...
plot \
 dir."mata-quadrate.gpd" using ($1/16384):($2/DEVIDER) w l ls 1 ti "{/Serif=15 квадрат}", \
 dir."mata-shell.gpd"    using ($1/16384):($2/DEVIDER) w l ls 2 ti "{/Serif=15 трубка }", \
 dir."mata-cross.gpd"    using ($1/16384):($2/DEVIDER) w l ls 3 ti "{/Serif=15 крестовина }", \
 dir."mata-circ.gpd"     using ($1/16384):($2/DEVIDER) w l ls 4 ti "{/Serif=15 круг }", \
 "../../ch_fork.gpd" using ($1/16384):($2/DEVIDER) w lp ls 5 ti "{/Serif=15 нижня оценка}" , \
 "../../ch_fork.gpd" using ($1/16384):($14/DEVIDER) w lp ls 6 ti "{/Serif=15 верхняя оценка}", \
 "../../ch.gpd" using ($1/16384):($2/DEVIDER) w l ls 7 ti "{/Serif=15 формула Хашина-Хилла}"#, \
