...
set ylabel "Коэффициент {/Symbol K_{/Nosymbol xy}}" font "Arial, 30"# offset 2
...
plot \
 "../../ch_fork.gpd" using ($1/16384):($13) w lp ls 5 ti "{/Arial=20 нижня оценка}" , \
 "../../ch_fork.gpd" using ($1/16384):($25) w lp ls 6 ti "{/Arial=20 верхняя оценка}", \
 "mata-hexagon.gpd" using ($1):($13) w lp lt 2 ti "{/Arial=20 hex}"
