...
plot \
 "../concrete/mata-quadrate.gpd" using ($1/16384):($8) w l ls 1 ti "{/Arial=20 квадрат}",\
 "../concrete/mata-shell.gpd" using ($1/16384):($8) w l ls 2 ti "{/Arial=20 трубка}",\
 "../concrete/mata-cross.gpd" using ($1/16384):($8) w l ls 3 ti "{/Arial=20 крестовина}", \
 "../concrete/mata-circ.gpd" using ($1/16384):($8) w l ls 4 ti "{/Arial=20 круг}", \
 "../../ch_fork.gpd" using ($1/16384):($8) w lp ls 5 ti "{/Arial=20 нижня оценка}" , \
 "../../ch_fork.gpd" using ($1/16384):($20) w lp ls 6 ti "{/Arial=20 верхняя оценка}", \
 "mata-hexagon.gpd" using ($1):($8) w lp lt 2 ti "{/Arial=20 hex}"
