...
plot \
 ...
 "../../ch_fork.gpd" using ($1/16384):($4) w lp ls 5 ti "{/Arial=20 нижня оценка}" , \
 "../../ch_fork.gpd" using ($1/16384):($16) w lp ls 6 ti "{/Arial=20 верхняя оценка}", \
 "mata-hexagon.gpd" using ($1):($4) w lp lt 2 ti "{/Arial=20 hex}"
