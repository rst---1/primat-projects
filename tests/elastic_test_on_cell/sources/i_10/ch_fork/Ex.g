...
plot \
 "../../mata-quadrate.gpd" using ($1/16384):($2/DEVIDER) w l ls 1 ti "{/Arial=30 квадрат}", \
 ...
 "../../ch_fork.gpd" using ($1/16384):($2/DEVIDER) w lp ls 5 ti "{/Arial=20 нижня оценка}" , \
 "../../ch_fork.gpd" using ($1/16384):($14/DEVIDER) w lp ls 6 ti "{/Arial=20 верхняя оценка}", \
 "mata-hexagon.gpd" using ($1):($2/DEVIDER) w lp lt 2 ti "{/Arial=20 hex}"#, \
