...
set ytics 0.0, 0.04, 1
set key spacing 2.4
# \n Рис.3. Сравнение макротеплопроводности ячейки для \n включений различной формы
set xlabel "Коэффициент армирования {с}" font "Arial, 25"
set ylabel "" font "Arial, 25" offset 2
...
plot \
 "../comp.gpd" using ($1/16384):(($3-$2)/$2) w l ls 1 ti "{/Arial=20 круг}",\
 "../comp.gpd" using ($1/16384):(($4-$2)/$2) w l ls 2 ti "{/Arial=20 крестовина}",\
 "../comp.gpd" using ($1/16384):(($5-$2)/$2) w l ls 3 ti "{/Arial=20 трубка}"
