...
plot \
 "concrete/mata-quadrate.gpd" using ($1/16384):($3) w l ls 1 ti "{/Arial=20 квадрат}",\
 "concrete/mata-shell.gpd" using ($1/16384):($3) w l ls 2 ti "{/Arial=20 трубка}",\
 "concrete/mata-cross.gpd" using ($1/16384):($3) w l ls 3 ti "{/Arial=20 крестовина}", \
 "concrete/mata-circ.gpd" using ($1/16384):($3) w l ls 4 ti "{/Arial=20 круг}"
