...
set output "Mxz_i_10 крестовина.png"
set multiplot
...
plot \
 "../mata-cross.gpd" using ($1/16384):($12) w l ti "{/Monospace=20 крестовина}" lt 1 lw WEIGHT, \
 "../mata-cross.gpd" using ($1/16384):($13) w l ti "{/Monospace=20 верхняя граница}" lt 2 lw WEIGHT, \
 "../mata-cross.gpd" using ($1/16384):($14) w l ti "{/Monospace=20 нижняя граница}" lt 3 lw WEIGHT, \
 "../mata-cross.gpd" using ($1/16384):($12-($13+$14)/2.0) w l ti "{/Monospace=20 нижняя граница}" lt 4 lw WEIGHT#, \
...
set grid x y
plot \
"../mata-cross.gpd" using ($1/16384):(($13-$12)/$12) \
w l ti "{/Monospace=20 верхняя граница}" lt 2 lw WEIGHT, \
"../mata-cross.gpd" using ($1/16384):(($12-$14)/$12) \
w l ti "{/Monospace=20 нижняя граница}" lt 3 lw WEIGHT, \
"../mata-cross.gpd" using ($1/16384):(((($12-($13+$14)/2.0)**2.0)**0.5)/$12) \
