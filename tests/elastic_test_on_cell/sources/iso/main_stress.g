...
#set ytics 0,0.1,1.0
#set size 2.0, 1.0
set terminal postscript enhanced "Times-Roman" 40 size 15, 15
unset key
set pm3d map
set xlabel "X"
set ylabel "Y"
