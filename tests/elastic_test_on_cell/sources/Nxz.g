...
set ylabel "Коеффициент Пуассона {N_{xz}}" font "Monospace, 25" offset 2

plot \
 "mata-quadrate r-4 new.gpd" using ($1/16384):($4) w l ti "{/Monospace=20 3 квадрат {{/Symbol=20 l}_{Кв}}}" lt 1 lw WEIGHT,\
 "mata-shell r-3.gpd" using ($1/16384):($4) w l ti "{/Monospace=20 4 трубка {{/Symbol=20 l}_{Тр}}}" lt 2 lw WEIGHT,\
 "mata-cross r-3.gpd" using ($1/16384):($4) w l ti "{/Monospace=20 5 крестовина {{/Symbol=20 l}_{Кр}}}" lt 3 lw WEIGHT, \
 "mata-circ r-7.gpd" using ($1/16384):($4) w l ti "{/Monospace=20 6 круг {{/Symbol=20 l}_{Кр}}}" lt 4 lw WEIGHT
