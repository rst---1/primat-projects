...
set xrange [ 0.01 : 1 ]
set yrange [ 0 : 1.6 ]
set xtics 0.01,0.11,1
set ytics 0,0.2,1.6
set grid x y
plot \
 "../mata-0.2.gpd" u (1/$1):(abs($6 - $2) / $2) w l ls 1 ti "" , \
 "../mata-0.2.gpd" u (1/$1):(abs($6 - $3) / $3) w l ls 2 ti "" , \
 "../mata-0.2.gpd" u (1/$1):(abs($6 - $4) / $4) w l ls 3 ti "" , \
 "../mata-0.2.gpd" u (1/$1):(abs($6 - $5) / $5) w l ls 4 ti ""
...
set grid x y
plot \
 "../mata-0.2.gpd" u (1/$1):(abs(arithmetic(0.19140,$1,1) - $2) / $2) w l ls 1 ti "" , \
 "../mata-0.2.gpd" u (1/$1):(abs(arithmetic(0.19140,$1,1) - $3) / $3) w l ls 2 ti "" , \
 "../mata-0.2.gpd" u (1/$1):(abs(arithmetic(0.19140,$1,1) - $4) / $4) w l ls 3 ti "" , \
 "../mata-0.2.gpd" u (1/$1):(abs(arithmetic(0.19140,$1,1) - $5) / $5) w l ls 4 ti ""
