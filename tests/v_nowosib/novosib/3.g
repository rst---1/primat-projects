...
plot \
 "../mata-hexagon.gpd" using ($1):($2/DEVIDER) w l ls 4 ti "{/Serif=15 круг}", \
 "../mata-hexagon.gpd" using ($1):($5/DEVIDER) w l ls 2 ti "{/Serif=15 формула Хашина-Штрикмана}", \
 "../mata-hexagon.gpd" using ($1):($6/DEVIDER) w l ls 3 ti "{/Serif=15 формула Ванина}"
