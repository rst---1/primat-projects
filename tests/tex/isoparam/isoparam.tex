...
\frame{ \frametitle{Треугольный элемент} 
...
\begin{equation}
    \begin{array}{c}
    \mathrm{x(s,r)=x_1+(x_2-x_1)s+(x_3-x_1)r} \\
    \mathrm{y(s,r)=y_1+(y_2-y_1)s+(y_3-y_1)r}
    \end{array} 
\end{equation}

\begin{equation}
    \mathrm{f(s,r)=f_1+(f_2-f_1)s+(f_3-f_1)r}
\end{equation}
...
\begin{equation}
    \begin{array}{l}
    \mathrm{s(x,y)= (a_xc_y-a_yc_x+c_xy-c_yx) / (b_yc_x - b_xc_y)} \\
    \mathrm{r(x,y)= (a_yc_x-a_xc_y+b_yx-b_xy) / (b_yc_x - b_xc_y)} \\
    \end{array} 
\end{equation}
...
\frame{ \frametitle{Четырёхугольный элемент} 
...
\begin{equation}
    \begin{array}{c}
    \mathrm{x(s,r)=x_1+(x_2-x_1)s+(x_4-x_1)r+(x_3+x_1-x_2-x_4)sr} \\
    \mathrm{y(s,r)=y_1+(y_2-y_1)s+(y_4-y_1)r+(y_3+y_1-y_2-y_4)sr}
    \end{array} 
\end{equation}

\begin{equation}
    \mathrm{f(s,r)=f_1+(f_2-f_1)s+(f_4-f_1)r+(f_3+f_1-f_2-f_4)sr}
\end{equation}
...
%         \mathrm{b_x = x2 - x1} \\
%         \mathrm{c_x = x4 - x1} \\
%         \mathrm{d_x = x3 - x2 - x4 + x1} \\
% 
%         \mathrm{a_y = y1} \\
%         \mathrm{b_y = y2 - y1} \\
%         \mathrm{c_y = y4 - y1} \\
%         \mathrm{d_y = y3 - y2 - y4 + y1} \\
%     \end{array} 
% \end{equation}
% }
...
Если
\begin{equation}
    \mathrm{A_s \ne 0} \ \text{и} \ \mathrm{A_r \ne 0}
\end{equation}
То
\begin{equation}
    \begin{array}{c}
    \mathrm{s(x,y)= \frac{B_s(x,y)-\sqrt{B_s(x,y)^2-4A_sC_s(x,y)}}{2A_s}}\\
    \mathrm{r(x,y)= \frac{B_r(x,y)+\sqrt{B_r(x,y)^2-4A_rC_r(x,y)}}{2A_r}}
    \end{array} 
\end{equation}
Иначе
\begin{equation}
    \begin{array}{c}
    \mathrm{s(x,y)= \frac{C_s(x,y)}{B_s(x,y)}}\\
    \mathrm{r(x,y)= \frac{C_r(x,y)}{B_r(x,y)}}
    \end{array} 
\end{equation}
\\
\begin{equation}
...
\frame{ \frametitle{Четырёхугольный элемент} 
% \left(\begin{equation}asdsd\end{equation}\right)

    % \begin{array}{l}
        % s(x,y)= \left< a \right. \\
        % \mathrm{s(x,y)= \left< begin{array}{l} \frac{B_s(x,y)-sqrt(B_s(x,y)^2-4A_sC_s(x,y))}{2A_s} \\ -frac{C_s(x,y)}{B)s(x,y)} end{array}\right. } \\
    % \mathrm{r(x,y)= (a_yc_x-a_xc_y+b_yx-b_xy) / (b_yc_x - b_xc_y)} \\
    % \end{array} 
...
\begin{equation}
    \begin{array}{l}
        ...
        \mathrm{b_x = x_2 - x_1} \\
        \mathrm{c_x = x_4 - x_1} \\
        \mathrm{d_x = x_3 - x_2 - x_4 + x_1} \\

        \mathrm{a_y = y_1} \\
        \mathrm{b_y = y_2 - y_1} \\
        \mathrm{c_y = y_4 - y_1} \\
        \mathrm{d_y = y_3 - y_2 - y_4 + y_1} 
    \end{array} 
\end{equation}
}
\frame{ \frametitle{Четырёхугольный элемент} 
...
\begin{equation}
    \begin{array}{l}
        \mathrm{\frac{\partial f}{\partial x} = (f_2-f_1)\frac{\partial s}{\partial x}+(f_4-f_1)\frac{\partial r}{\partial x}+(f_3-f_2-f_4+f_1)(\frac{\partial s}{\partial x}r + s\frac{\partial r}{\partial x})} \\ 
        \mathrm{\frac{\partial f}{\partial y} = (f_2-f_1)\frac{\partial s}{\partial y}+(f_4-f_1)\frac{\partial r}{\partial y}+(f_3-f_2-f_4+f_1)(\frac{\partial s}{\partial y}r + s\frac{\partial r}{\partial y})}
    \end{array} 
\end{equation}
}
\frame{ \frametitle{Четырёхугольный элемент} 
...
\begin{equation}
    \begin{array}{c}
        \mathrm{\frac{\partial s}{\partial x}= \frac{-d_y}{2A_s}-\frac{d_yB_s(x,y)+2c_yA_s}{2A_s\sqrt{B_s(x,y)^2-4A_sC_s(x,y)}}}\\
        \mathrm{\frac{\partial r}{\partial x}= \frac{-d_y}{2A_s}+\frac{d_yB_r(x,y)+2b_yA_r}{2A_r\sqrt{B_r(x,y)^2-4A_rC_r(x,y)}}}\\
    \end{array} 
\end{equation}
Иначе
\begin{equation}
    \begin{array}{c}
    \mathrm{\frac{\partial s}{\partial x}= \frac{c_yB_s(x,y) + C_s(x,y)d_y}{B_s^2(x,y)}}\\
    \mathrm{\frac{\partial r}{\partial x}= \frac{b_yB_r(x,y) + C_r(x,y)d_y}{B_r^2(x,y)}}
    \end{array} 
\end{equation}
}
\end{document} 
