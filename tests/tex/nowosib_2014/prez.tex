...
\begin{figure}
    \begin{center}
        \includegraphics[scale=0.2]{grill}
    \end{center}
\end{figure}
...
\frame{ \frametitle{Периодические ячейки с двумя формами решеток} 

% \begin{figure}[h]
%     % \begin{center}
%         \begin{minipage}[h]{0.4\linewidth}
%             \includegraphics[width=0.5\linewidth]{terra} a
%             % \caption{Тетрагональная решетка.} 
%         \end{minipage}
%         \hfill 
%         \begin{minipage}[h]{0.4\linewidth}
%             \includegraphics[width=0.5\linewidth]{gexa} b
...
\begin{figure}[h]
    \begin{minipage}[h]{0.49\linewidth}
        \center{\includegraphics[width=0.64\linewidth]{terra} \\ Тетрагональная решетка.}
    \end{minipage}
    \hfill
    \begin{minipage}[h]{0.49\linewidth}
        \center{\includegraphics[width=0.35\linewidth]{gexa} \\ Гексагональная решетка.}
    \end{minipage}
