...
for i_Files in range(len(Slice_y_)):					#Big Loop
	FileName0 = DIRECTORY + "/" + ComparingFile_1 + " U_y_gradY when y(" + str(Slice_y_[i_Files]) + ").gpl"
	FileName1 = DIRECTORY + "/" + ComparingFile_2 + " U_y_gradY when y(" + str(Slice_y_[i_Files]) + ").gpl"
	FileNameOut = DIRECTORY + "/" + ComparingFile_OUT + " U_y_gradY when y(" + str(Slice_y_[i_Files]) + ").gpl"
