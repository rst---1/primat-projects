...
while (let "number<number_x")
do
	"$DIRECTORY/3_.sh" "${A_Tau_xx_x_[$number]}" "${D_Tau_xx_x_[$number]}" "1" ${Slice_x_[$number]} "$DOWN_tau_xx_when_x" "$UP___tau_xx_when_x"
	let "number += 1"
done
...
while (let "number<number_y")
do
	"$DIRECTORY/3_.sh" "${A_Tau_xx_y_[$number]}" "${D_Tau_xx_y_[$number]}" "2" ${Slice_y_[$number]} "$DOWN_tau_xx_when_y" "$UP___tau_xx_when_y"
	let "number += 1"
done
...
while (let "number<number_x")
do
	"$DIRECTORY/3_.sh" "${A_Tau_yy_x_[$number]}" "${D_Tau_yy_x_[$number]}" "3" ${Slice_x_[$number]} "$DOWN_tau_yy_when_x" "$UP___tau_yy_when_x"
	let "number += 1"
done
...
while (let "number<number_y")
do
	"$DIRECTORY/3_.sh" "${A_Tau_yy_y_[$number]}" "${D_Tau_yy_y_[$number]}" "4" ${Slice_y_[$number]} "$DOWN_tau_yy_when_y" "$UP___tau_yy_when_y"
	let "number += 1"
done
...
while (let "number<number_x")
do
	"$DIRECTORY/3_.sh" "${A_Tau_xy_x_[$number]}" "${D_Tau_xy_x_[$number]}" "1" ${Slice_x_[$number]} "$DOWN_tau_xy_when_x" "$UP___tau_xy_when_x"
	let "number += 1"
done
...
while (let "number<number_y")
do
	"$DIRECTORY/3_.sh" "${A_Tau_xy_y_[$number]}" "${D_Tau_xy_y_[$number]}" "2" ${Slice_y_[$number]} "$DOWN_tau_xy_when_y" "$UP___tau_xy_when_y"
	let "number += 1"
done
...
while (let "number<number_x")
do
	"$DIRECTORY/3_.sh" "${A_Tau_zz_x_[$number]}" "${D_Tau_zz_x_[$number]}" "3" ${Slice_x_[$number]} "$DOWN_tau_zz_when_x" "$UP___tau_zz_when_x"
	let "number += 1"
done
...
while (let "number<number_y")
do
	"$DIRECTORY/3_.sh" "${A_Tau_zz_y_[$number]}" "${D_Tau_zz_y_[$number]}" "4" ${Slice_y_[$number]} "$DOWN_tau_zz_when_y" "$UP___tau_zz_when_y"
	let "number += 1"
done
