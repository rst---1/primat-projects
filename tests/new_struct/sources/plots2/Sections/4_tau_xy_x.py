...
for i_Files in range(len(Slice_x_)):					#Big Loop
	FileName0 = DIRECTORY + "/" + ComparingFile_1 + " tau_xy when x(" + str(Slice_x_[i_Files]) + ").gpl"
	FileName1 = DIRECTORY + "/" + ComparingFile_2 + " tau_xy when x(" + str(Slice_x_[i_Files]) + ").gpl"
	FileNameOut = DIRECTORY + "/" + ComparingFile_OUT + " tau_xy when x(" + str(Slice_x_[i_Files]) + ").gpl"
