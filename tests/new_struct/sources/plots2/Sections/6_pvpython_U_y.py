...
#open file
from paraview.simple import *
reader_2 = CSVReader(FileName = [DIRECTORY_OF_IN_U_y_A])
...
for i_Files in range(len(Slice_x_)):
	...
	#Render()
	writer = CreateWriter(DIRECTORY_OF_OUT + "/" + CSV_U_FILENAME_2 + " U_y when x("+str(Slice_x_[i_Files])+").csv")
	writer.WriteAllTimeSteps = 1
	writer.FieldAssociation = "Points"
	writer.UpdatePipeline()
#---------------------------------------------------------
for i_Files in range(len(Slice_y_)):
	...
	#Render()
	writer = CreateWriter(DIRECTORY_OF_OUT + "/" + CSV_U_FILENAME_2 + " U_y when y("+str(Slice_y_[i_Files])+").csv")
	writer.WriteAllTimeSteps = 1
	writer.FieldAssociation = "Points"
	writer.UpdatePipeline()
#---------------------------------------------------------
...
#open file
from paraview.simple import *
reader_4 = CSVReader(FileName = [DIRECTORY_OF_IN_U_y_A])
...
for i_Files in range(len(Slice_x_)):
	...
	#Render()
	writer = CreateWriter(DIRECTORY_OF_OUT + "/" + CSV_U_FILENAME_2 + " U_y_gradX when x("+str(Slice_x_[i_Files])+").csv")
	writer.WriteAllTimeSteps = 1
	writer.FieldAssociation = "Points"
	writer.UpdatePipeline()
#---------------------------------------------------------
for i_Files in range(len(Slice_y_)):
	...
	#Render()
	writer = CreateWriter(DIRECTORY_OF_OUT + "/" + CSV_U_FILENAME_2 + " U_y_gradX when y("+str(Slice_y_[i_Files])+").csv")
	writer.WriteAllTimeSteps = 1
	writer.FieldAssociation = "Points"
	writer.UpdatePipeline()
#---------------------------------------------------------
...
#open file
from paraview.simple import *
reader_6 = CSVReader(FileName = [DIRECTORY_OF_IN_U_y_A])
...
for i_Files in range(len(Slice_x_)):
	...
	#Render()
	writer = CreateWriter(DIRECTORY_OF_OUT + "/" + CSV_U_FILENAME_2 + " U_y_gradY when x("+str(Slice_x_[i_Files])+").csv")
	writer.WriteAllTimeSteps = 1
	writer.FieldAssociation = "Points"
	writer.UpdatePipeline()
#---------------------------------------------------------
for i_Files in range(len(Slice_y_)):
	...
	#Render()
	writer = CreateWriter(DIRECTORY_OF_OUT + "/" + CSV_U_FILENAME_2 + " U_y_gradY when y("+str(Slice_y_[i_Files])+").csv")
	writer.WriteAllTimeSteps = 1
	writer.FieldAssociation = "Points"
	writer.UpdatePipeline()
#---------------------------------------------------------
