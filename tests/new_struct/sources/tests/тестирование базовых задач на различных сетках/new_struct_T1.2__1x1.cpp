...
dbl Analytic_function (const dealii::Point<2> p, cst n, dbl nu)	//посмотреть b(ширину)      посмотреть C0 большое
{
...
//		static char *MeshFileName = "1x1_T1.2.msh";
		static char *MeshFileName = "1x1_T1.2_nestr.msh";
