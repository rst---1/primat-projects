...
#include "new_struct_elastic_T2.1_slayer3.cpp"
//#include "new_struct_elastic_T2.2_slayer3.cpp"

//#include "new_struct_temperature.cpp"
#include "new_struct_temperature_T1.1_slayer3.cpp"
//#include "new_struct_temperature_T1.2_slayer3.cpp"
//#include "new_struct_temperature_T1.1.cpp"
//#include "new_struct_temperature_T1.2.cpp"


int main1(int RefineNum, const double bb, const double Yleft, const double Yright, const double Xdown, const double Xup, const string FileOfGrid, const double Yung1, const double Yung2, const double Yung3, const double c0, const double C0, double eps )
{
	enum {x, y, z};
	std::cout << "\n\n================================================================================\n";
	std::cout << "================================================================================\n";
...
//		Domain<2> domain;
//		const double Yung1		= 1.0;		//E										//INPUT
//		const double Yung2		= 1.0;		//E										//INPUT
//		const double Yung3		= 1.0;		//E										//INPUT
		const double Puasson1	= 0.25;		//nu									//INPUT
		const double Puasson2	= 0.25;		//nu									//INPUT
		const double Puasson3	= 0.25;		//nu									//INPUT
//		const double c0	 	= 0.5;													//INPUT
//		const double C0	 	= 1.0;													//INPUT
...
//		string FileOfGrid = "1x1_T2.2.msh";
//		string FileOfGrid = "net/1x1_slayer3.msh";
//		string FileOfGrid = "net/1x5_slayer3.msh";
//		string FileOfGrid = "net/1x10_slayer3.msh";
//		string FileOfGrid = "net/1x1_slayer3_unregular.msh";
//		string FileOfGrid = "net/1x5_slayer3_unregular.msh";
//		string FileOfGrid = "net/1x10_slayer3_unregular.msh";
//		const double bb		= 5.0;			// ширина балки							//INPUT
//		double		Yleft	=	-2.5;												//INPUT
//		double		Yright	=	2.5;												//INPUT
//		double		Xup		=	1.0;												//INPUT
//		double		Xdown	=	0.0;												//INPUT

		double IntegralCoefficient = 0.0;										//На сколько приподнять функцию U_z
//		double IntegralCoefficient = 0.0032653061224;
//		double IntegralCoefficient = 0.0008;
//		double IntegralCoefficient = 22727779800.47;
//		double IntegralCoefficient = 0.00285714285714;
//		double IntegralCoefficient = 0.0032;
//		double IntegralCoefficient = 0.002857;

		FILE *FU_x;				FU_x = fopen ("out/FU_x.gpl", "w+");					//U_x
...
/*
	bb = 10.0;	Yleft = -5.0; Yright = 5.0; Xdown = 0.0; Xup = 1.0; FileOfGrid = "net/1x10_slayer3_unregular.msh"; c0 = 0.5; C0 = 4.325; eps = 1e-12;
	main1( 1, bb, Yleft, Yright, Xdown, Xup, FileOfGrid, Yung1, Yung2, Yung3, c0, C0, eps );

	bb = 5.0;	Yleft = -2.5; Yright = 2.5; Xdown = 0.0; Xup = 1.0; FileOfGrid = "net/1x5_slayer3_unregular.msh"; c0 = 0.5; C0 = 263.0/240.0; eps = 1e-12;
	main1( 1, bb, Yleft, Yright, Xdown, Xup, FileOfGrid, Yung1, Yung2, Yung3, c0, C0, eps );
*/

	bb = 1.0;	Yleft = -0.5; Yright = 0.5; Xdown = 0.0; Xup = 1.0; FileOfGrid = "net/1x1_slayer3_unregular.msh"; c0 = 0.5; C0 = 0.0; eps = 1e-12;
	main1( 1, bb, Yleft, Yright, Xdown, Xup, FileOfGrid, Yung1, Yung2, Yung3, c0, C0, eps );

/*
	bb = 10.0;	Yleft = -5.0; Yright = 5.0; Xdown = 0.0; Xup = 1.0; FileOfGrid = "net/1x10_slayer3.msh"; c0 = 0.5; C0 = 4.325; eps = 1e-12;
	main1( 3, bb, Yleft, Yright, Xdown, Xup, FileOfGrid, Yung1, Yung2, Yung3, c0, C0, eps );		//14

	bb = 5.0;	Yleft = -2.5; Yright = 2.5; Xdown = 0.0; Xup = 1.0; FileOfGrid = "net/1x5_slayer3.msh"; c0 = 0.5; C0 = 263.0/240.0; eps = 1e-12;
