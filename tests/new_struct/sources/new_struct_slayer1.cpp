...
#include "new_struct_elastic_T2.1.cpp"
//#include "new_struct_elastic_T2.2.cpp"



int main1(int RefineNum)
{
	enum {x, y, z};
	std::cout << "\n\n================================================================================\n";
	std::cout << "================================================================================\n";
...
//		Domain<2> domain;
		const double Yung		= 2.0;		//E										//INPUT
		const double Puasson	= 0.25;		//nu									//INPUT
		const double c0	 	= 0.5;													//INPUT
		const double C0	 	= 0.0;													//INPUT
		const double bb		= 1.0;			// ширина балки							//INPUT
	    const double mu = Yung / ( 2.0 * ( 1.0 + Puasson ) );
//		string FileOfGrid = "1x1_T1.2.msh";
...
//TEMPERATURE BLOCK
	if (0)
	{
		...
		NEW_STRUCT_TEMPERATURE::main(Yung, Puasson, c0, C0, bb, mu, FileOfGrid, Yleft, Yright, Xup, Xdown, RefineNum, IntegralCoefficient, FILES);
	}
...
//ELASTIC BLOCK
	if (1)
	{
		NEW_STRUCT_ELASTIC::main(Yung, Puasson, c0, C0, bb, mu, FileOfGrid, Yleft, Yright, Xup, Xdown, RefineNum, IntegralCoefficient, eps, FILES);
	}
