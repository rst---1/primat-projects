...
template<bool type_space>
void DomainLooper<2, type_space>::
set_ratio_black_to_white (BlackOnWhiteSubstituter &bows)
{
...
template<bool type_space>
void DomainLooper<2, type_space>::
add_nodes_in_csp (const BlackOnWhiteSubstituter &bows, 
...
template<bool type_space>
prmt::Report DomainLooper<2, type_space>::loop_domain (
